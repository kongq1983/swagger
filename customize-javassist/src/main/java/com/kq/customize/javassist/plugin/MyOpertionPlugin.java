...
@Component
@Order
public class MyOpertionPlugin extends MyBaseBuildPlugin implements OperationBuilderPlugin {
    ...
    public void apply(OperationContext operationContext) {
        if(operationContext.getReturnType().canCreateSubtype(String.class) ||
            ...
            if(optionalArray.isPresent()){
                ...
                Optional<ApiReturnJsonObject> optional = operationContext.findAnnotation(ApiReturnJsonObject.class);
     ...
     * }
     * */
    private void createResultAnnotationRefModel(OperationContext operationContext,ApiReturnJsonObject object,boolean isArray){
        //model 名称
        String name = object.name();
        int paramIndex = MyBaseBuildPlugin.paramIndex++;
        ApiJsonProperty[] properties = object.value();
    ...
    private void createResultAnnotationRefModelObject(OperationContext operationContext,
                                                      ApiJsonProperty[] properties,String resultname,String classname,boolean isArray){
